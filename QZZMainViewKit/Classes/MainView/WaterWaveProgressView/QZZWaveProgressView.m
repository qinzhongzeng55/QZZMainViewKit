//
//  QZZWaveProgressView.m
//
//
//  Created by qinzhongzeng on 16/8/1.
//  Copyright © 2016年 qinzhongzeng. All rights reserved.
//

#define QZZDefaultFirstWaveColor [UIColor colorWithRed:34/255.0 green:116/255.0 blue:210/255.0 alpha:1]
#define QZZDefaultSecondWaveColor [UIColor colorWithRed:34/255.0 green:116/255.0 blue:210/255.0 alpha:0.3]
//#define LXDefaultSecondWaveColor [UIColor colorWithRed:207/255.0 green:237/255.0 blue:255/255.0 alpha:1]

#import "QZZWaveProgressView.h"
...
- (void)startWaveAnimation{
    self.timer = [CADisplayLink displayLinkWithTarget:[QZZWeakProxy proxyWithTarget:self] selector:@selector(waveAnimation)];
